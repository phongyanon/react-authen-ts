...
const Document: React.FC = () => {
	...
	return (
		...
		<Paper p={36} mt={16} shadow="md" radius="md" withBorder>
			<Center pb={12}><Title order={3}>Document</Title></Center>
			<Text size="lg" fw={700} mb={'lg'} mt="xl">Paper is the most basic ui component</Text>
      <Text>
        ...
        with shadow
			...
			<Text size="lg" fw={700} mt={'lg'}>Why do we use it?</Text>
			<Text>
			...
			<Text size="lg" fw={700} mt={'lg'}>Where does it come from?</Text>
			<Text>
			...
			<Blockquote color="blue" cite="– Developer team" icon={<IconInfoCircle/>} mt="xl">
